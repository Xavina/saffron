...
function createAssistantSession(client, options = {}) {
    return client.createSession(createAssistantSessionConfig(options));
}

function resumeAssistantSession(client, sessionId, options = {}) {
    return client.resumeSession(sessionId, createAssistantSessionConfig(options));
}

function createAssistantSessionConfig(options = {}) {
    return {
        ...
        systemMessage: {
            content: [
                ...
                'Use the provided SpiceDB custom tools for schema and permission questions.',
